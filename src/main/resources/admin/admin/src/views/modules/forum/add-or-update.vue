...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   banzhuId: [
                              { required: true, message: '版主不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
         ...
         this.$http({
             url: `banzhu/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.banzhuOptions = data.data.list;
            }
         });
         this.$http({
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.banzhuChange(data.data.banzhuId)
